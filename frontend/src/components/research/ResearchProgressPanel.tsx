    ...
    <div className="bg-white dark:bg-stone-900 rounded-lg shadow-sm border border-stone-200 dark:border-stone-800 p-6">
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-stone-600 dark:text-stone-400">{task.query}</p>
        </div>
        <button
          onClick={handleCancel}
          disabled={cancelResearch.isPending}
          className="text-stone-500 hover:text-red-500 dark:text-stone-400 dark:hover:text-red-400 transition-colors"
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between text-sm mb-2">
          ...
          <span className="text-stone-500 dark:text-stone-400">{task.progress_percentage}%</span>
        </div>
