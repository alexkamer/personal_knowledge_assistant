...
export function BacklinksPanel({ noteId, onNavigate }: BacklinksPanelProps) {
  ...
  if (loading) {
    return (
      <div className="mt-6 pt-6 border-t border-gray-200">
        <h3 className="text-sm font-semibold text-gray-700 mb-3">Linked References</h3>
  ...
  if (backlinks.length === 0) {
    return (
      <div className="mt-6 pt-6 border-t border-gray-200">
        <h3 className="text-sm font-semibold text-gray-700 mb-3">Linked References</h3>
        <p className="text-sm text-gray-500 italic">No other notes link to this note yet.</p>
      </div>
    );
  }
    ...
    <div className="mt-6 pt-6 border-t border-gray-200">
      ...
      <div className="space-y-2">
        {backlinks.map((backlink) => (
          ...
          >
            <ArrowLeft size={14} className="text-gray-400 group-hover:text-blue-600 flex-shrink-0" />
